    ...
    <>
      <div className="flex flex-col gap-[64px] px-5 min-[768px]:px-[20px] min-[1024px]:px-[64px] py-6 max-[550px]:px-4 max-[700px]:gap-9" style={{ flex: 3, marginRight: "auto", marginLeft: "auto", maxWidth: "1444px" }}>
        ...
        <div className="flex flex-col gap-[24px] ">
          <hr />
          <p className="text-[12px] text-gray-400 ">Last updated: August 01, 2024</p>
          <p className="text-[14px] font-normal  leading-[28.8px] tradcking-[0.8px] text-white md:text-[16px] text-center">
          ...
          <div className="flex flex-col gap-[8px]">
            <div className=" mx-auto p-4 text-white">
              ...
              <ul className="list-disc pl-5 mb-4">
                ...
                <li className="mb-2">
                  <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Quizango Media Private Limited, 55, 2ND FLOOR, LANE-2, WESTEND MARG, SAIDULLAJAB, NEAR SAKET METRA STATION, NEW DELHI, DELHI, 110030.
                </li>
                <li className="mb-2">
                ...
                <li className="mb-2">
                  <strong>Website</strong> refers to Puno Games - Play Free Online Games, accessible from <a href="https://www.punogames.com/" className="text-blue-600 underline">https://www.punogames.com/</a>.
                </li>
                <li className="mb-2">
              ...
              <h2 className="text-white font-bold text-[24px]">Collecting and Using Your Personal Data:</h2>

              <h3 className="text-lg font-semibold mt-4 mb-2">Types of Data Collected</h3>

              <h4 className="text-md font-semibold mt-3 mb-1">Personal Data</h4>
              <p className="mb-4">
              ...
              <h4 className="text-md font-semibold mt-3 mb-1">Usage Data</h4>
              <p className="mb-4">
              ...
              <h4 className="text-md font-semibold mt-3 mb-1">Tracking Technologies and Cookies</h4>
              <p className="mb-4">
              ...
              <h3 className="text-lg font-semibold mt-4 mb-2">We may share Your personal information in the following situations:</h3>
              <ul className="list-disc pl-5 mb-4">
                <li className="mb-2">
              ...
              <h3 className="text-lg font-semibold mt-4 mb-2">Retention of Your Personal Data</h3>
              <p className="mb-4">
              ...
              <h3 className="text-lg font-semibold mt-4 mb-2">Transfer of Your Personal Data</h3>
              <p className="mb-4">
              ...
              <h3 className="text-lg font-semibold mt-4 mb-2">Delete Your Personal Data</h3>
              <p className="mb-4">
              ...
              <h4 className="text-md font-semibold mt-3 mb-1">Business Transactions</h4>
              <p className="mb-4">
                If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
              </p>

              <h4 className="text-md font-semibold mt-3 mb-1">Law enforcement</h4>
              <p className="mb-4">
                Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
              </p>

              <h4 className="text-md font-semibold mt-3 mb-1">Other legal requirements</h4>
              <p className="mb-4">
              ...
              <ul className="list-disc pl-5 mb-4">
                <li className="mb-2">
                  By visiting this page on our website: <a href="https://www.punogames.com/contact-us" className="text-blue-500 hover:underline">https://www.punogames.com/contact-us</a>
                </li>
              </ul>
              </div>
          </div>
