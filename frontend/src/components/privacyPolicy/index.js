          ...
          <div className="flex flex-col gap-[8px]">
            <div className=" mx-auto  text-white">
              ...
              <ul className="list-disc pl-5 mb-4">
                ...
                <li className="mb-2">
                  <strong>Website</strong> refers to Joyzapy Games - Play Free Online Games, accessible from <a href="https://www.joyzapy.com/" className="text-blue-600 underline">https://www.joyzapy.com/</a>.
                </li>
                <li className="mb-2">
              ...
              <ul className="list-disc pl-5 mb-4">
                <li className="mb-2">
                  By visiting this page on our website: <a href="https://www.joyzapy.com/contact-us" className="text-blue-500 hover:underline">https://www.joyzapy.com/contact-us</a>
                </li>
              </ul>
              </div>
          </div>
