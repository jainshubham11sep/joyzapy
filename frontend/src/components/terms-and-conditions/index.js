    ...
    <>
      <div className="flex flex-col gap-[64px] px-5 min-[768px]:px-[20px] min-[1024px]:px-[64px] py-6 max-[550px]:px-4 max-[700px]:gap-9" style={{ flex: 3, marginRight: "auto", marginLeft: "auto", maxWidth: "1444px" }}>
        <div className="text-[18px] font-semibold text-[#FEFEFE]">
          Home/<span className="text-[#15AEE3]">Terms and conditions</span>
        </div>
          ...
          <div className="flex flex-col gap-[8px]">
            <div className=" mx-auto p-4 text-white">
              ...
              <ul className="list-disc pl-5 mb-4">
                ...
                <li className="mb-2">
                  <strong>Terms and Conditions </strong> (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the Free Terms and Conditions Generator.
                </li>
                <li className="mb-2">
      ...
      <h2 className="text-xl font-semibold mb-4">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-semibold mb-4">For European Union (EU) Users</h2>
      <p className="mb-4">
        If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which You are resident.
      </p>

      <h2 className="text-xl font-semibold mb-4">United States Legal Compliance</h2>
      <p className="mb-4">
        You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.
      </p>

      <h2 className="text-xl font-semibold mb-4">Severability and Waiver</h2>
      ...
      <h2 className="text-xl font-semibold mb-4">Translation Interpretation</h2>
      <p className="mb-4">
        These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.
      </p>

      <h2 className="text-xl font-semibold mb-4">Changes to These Terms and Conditions</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        <br />
        • By email: admin@quizangomedia.com
      </p>
            </div>
          </div>
