        ...
        <div className="flex flex-col items-start justify-center gap-9 md:flex-row gap-[80px] md:gap-[77px] lg:gap-[180px] ">
          ...
          <div className="flex flex-col items-start justify-center gap-[39px]">
            ...
            <div className="relative">
              <input
                className="py-[7px] pl-4 pr-2 rounded-full w-[250px] md:w-[300px] h-[46px] font-inter font-normal text-sm leading-[16.94px] text-[#969696]"
                type="email"
                placeholder="Your email"
              />

              <svg
                className="absolute bg-[#0088DC] rounded-full bottom-[9px] right-[9px] p-[3px]"
