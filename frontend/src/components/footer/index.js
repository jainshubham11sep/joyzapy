            ...
            <div className="flex flex-col items-start gap-2">
              ...
              <div className="leading-[29px] text-[18px] font-normal">
                ...
                <br /> to us
                    ...
                    <div className='relative'>
                        ...
                        <svg className='absolute bg-[#0088DC] rounded-full bottom-[10px] right-[9px]' xmlns="http://www.w3.org/2000/svg" width="30" height="28" viewBox="0 0 24 24" fill="none">
                            <path d="M3.64011 18.3004L5.58011 11.5904L3.64011 4.88037C3.40011 4.06037 4.24011 3.33037 5.02011 3.70037L20.1201 10.6904C20.8901 11.0504 20.8901 12.1504 20.1201 12.5004L5.02011 19.4904C4.24011 19.8504 3.40011 19.1304 3.64011 18.3004Z" stroke="#F5F5F5" strokeWidth="1.2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M5.58008 11.5908H10.3701" stroke="#F5F5F5" strokeWidth="1.2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                ...
                <div className='flex flex-col items-start justify-center gap-[17px] px-[1px] py-[2px]'>
                    ...
                    <Link className='text-[18px] font-normal transition-colors duration-300 hover:text-blue-500' href="/game/Featured">Featured</Link>
                    <Link className='text-[18px] font-normal transition-colors duration-300 hover:text-blue-500' href="/game/Adventure">Adventure</Link>
                    <Link className='text-[18px] font-normal transition-colors duration-300 hover:text-blue-500' href="/game/Sports">Sports</Link>
                    <Link className='text-[18px] font-normal transition-colors duration-300 hover:text-blue-500' href="/game/Puzzle">Puzzle</Link>
                </div>
