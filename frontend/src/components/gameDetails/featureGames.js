    ...
    <>
      <div className="flex flex-col gap-4">
        ...
        <div className="overflow-hidden no_scrollbar relative">
          <button className="bg-[#2929299f] backdrop-blur-sm w-[150px] lg:w-[190px] h-[225px] lg:h-[298px] absolute text-white left-[-111px] top-[-33px] rounded-[50%] z-[1] flex items-center">
            <img src={"/assets/arrow.png"} alt="image" className=" absolute  right-[15px] lg:right-[33px]" />
          </button>
          <div
            itemsToShow={4}
          ...
          >
            {Array(8)
              .fill(0)
              .map((data) => (
                <div className="flex flex-col gap-4 relative w-[calc(100%/4)] min-w-[300px] max-[600px]:min-w-[164px]">
                  <img
          ...
          <button className="bg-[#2929299f] backdrop-blur-sm w-[150px] lg:w-[190px] h-[225px] lg:h-[298px] absolute text-white right-[-111px] top-[-33px] rounded-[50%] z-[1] flex items-center">
            <img
