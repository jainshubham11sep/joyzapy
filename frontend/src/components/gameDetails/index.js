...
const GameDetails = ({ data, featureGameData, relatedgames }) => {
  ...
  useEffect(() => {
    // Function to cheyouck aspect ratio
    
    const checkAspectRatio = () => {
      setIsLandscape(window.innerWidth > window.innerHeight*1.5);
      console.log(window.innerWidth,window.innerHeight,"jaiiiiiiii")
    };
...
console.log(isLandscape,"isLandscapeisLandscape")

  console.log(data, "partiigame data")
  ...
  return(
    ...
    (
      ...
      <div className="flex items-center justify-center h-screen">
        <p>Please rotate your screen to landscape mode.</p>
      </div>
    )
  )
